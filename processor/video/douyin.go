...
func (p *DouYinProcessor) method1(link string) error {
	...
	// 尝试方法3：备用方案 - 直接获取HTML内容（原始方法）
	utils.InfoWithFormat("尝试备用方案：直接获取HTML内容")
	//html, err := page.Content()
	//if err != nil {
	//	return fmt.Errorf("获取页面内容失败: %v", err)
	//}
	html := `<!DOCTYPE html><html style="font-size: 50px; --vh: 826px;"><head>
...
<div id="douyin_reflow_webId" webid="7568470684830303796" usercip="183.220.16.190"></div>
<div id="douyin_reflow_page"></div>
<script nonce="" src="https://privacy.zijieapi.com/api/web-cmp/sdk/?project_key=61566ccba19eeb6d"></script><script nonce="">!function(n,t){if(n.LogAnalyticsObject=t,!n[t]){function c(){c.q.push(arguments)}c.q=c.q||[],n[t]=c}n[t].l=+new Date}(window,"collectEvent")</script><script nonce="" async="" src="https://lf3-cdn-tos.bytescm.com/obj/static/log-sdk/collect/5.0/collect.js" crossorigin="anonymous"></script><script nonce="">!function(e,r,n,t,s,a,i,o,c,l,d,m,p,f){a="precollect",i="getAttribute",o="addEventListener",l=function(e){(d=[].slice.call(arguments)).push(Date.now(),location.href),(e==a?l.p.a:l.q).push(d)},l.q=[],l.p={a:[]},e[s]=l,(m=document.createElement("script")).src=n+"?bid=aweme_share&globalName="+s,m.crossOrigin=n.indexOf("sdk-web")>0?"anonymous":"use-credentials",r.getElementsByTagName("head")[0].appendChild(m),o in e&&(l.pcErr=function(r){r=r||e.event,(p=r.target||r.srcElement)instanceof Element||p instanceof HTMLElement?p[i]("integrity")?e[s](a,"sri",p[i]("href")||p[i]("src")):e[s](a,"st",{tagName:p.tagName,url:p[i]("href")||p[i]("src")}):e[s](a,"err",r.error||r.message)},l.pcRej=function(r){r=r||e.event,e[s](a,"err",r.reason||r.detail&&r.detail.reason)},e[o]("error",l.pcErr,!0),e[o]("unhandledrejection",l.pcRej,!0)),"PerformanceLongTaskTiming"in e&&((f=l.pp={entries:[]}).observer=new PerformanceObserver((function(e){f.entries=f.entries.concat(e.getEntries())})),f.observer.observe({entryTypes:["longtask","largest-contentful-paint","layout-shift"]}))}(window,document,"https://lf3-short.ibytedapm.com/slardar/fe/sdk-web/browser.cn.js",0,"slardar")</script><script nonce="">var regExpRes=location.pathname.match(/\/([^/?#]*)\/?$/);window.slardar("context.merge",{item_id:regExpRes&&regExpRes[1]}),window.slardar("init",{bid:"aweme_share",pid:"video_ssr",release:"1.0.0.2579",env:"online"}),window.slardar("on","beforeSend",(function(e){e.ev_type&&"performance"===e.ev_type&&("lcp"===e.payload.name&&(console.log("[dev]\u6267\u884c=>slardarLCP",(new Date).getTime()),window.slardarLcp=(new Date).getTime()));return e}))</script><script nonce="" id="__LOADABLE_REQUIRED_CHUNKS__" type="application/json">["7431","4097","5118","1006","3384","9973"]</script><script nonce="" id="__LOADABLE_REQUIRED_CHUNKS___ext" type="application/json">{"namedChunks":["video_(id)/page"]}</script><script nonce="" crossorigin="anonymous" defer="true" src="//lf-douyin-mobile.bytecdn.com/obj/growth-douyin-share/growth/douyin_ug/static/js/async/7431.689d5bb9.js"></script><script nonce="" crossorigin="anonymous" defer="true" src="//lf-douyin-mobile.bytecdn.com/obj/growth-douyin-share/growth/douyin_ug/static/js/async/4097.16d21948.js"></script><script nonce="" crossorigin="anonymous" defer="true" src="//lf-douyin-mobile.bytecdn.com/obj/growth-douyin-share/growth/douyin_ug/static/js/async/5118.1442fa2d.js"></script><script nonce="" crossorigin="anonymous" defer="true" src="//lf-douyin-mobile.bytecdn.com/obj/growth-douyin-share/growth/douyin_ug/static/js/async/1006.fc12eee8.js"></script><script nonce="" crossorigin="anonymous" defer="true" src="//lf-douyin-mobile.bytecdn.com/obj/growth-douyin-share/growth/douyin_ug/static/js/async/3384.f0fc9bd9.js"></script><script nonce="" crossorigin="anonymous" defer="true" src="//lf-douyin-mobile.bytecdn.com/obj/growth-douyin-share/growth/douyin_ug/static/js/async/video_(id)/page.15670c72.js"></script><script nonce="">window._SSR_DATA = {"data":{},"context":{"request":{"params":{},"query":{"region":"CN","mid":"7567686326007499574","u_code":"ej0dk7l2g004jm","did":"MS4wLjABAAAAUbqdg2vhJHRDnrU2k6QsMX9R8DJIDxbD8wjU_E9qx4GtnHvtF-aQdzAaHu7Awoye","iid":"MS4wLjABAAAANwkJuWIRFOzg5uCpDRpMj4OX-QryoDgn-yYlXQnRwQQ","with_sec_did":"1","video_share_track_ver":"","titleType":"title","share_sign":"nMTU61AnSNUe7Te.Ww32ku_0KQeXIscQMDEXnYlVjz8-","share_version":"170400","ts":"1762160029","from_aid":"6383","from_ssr":"1","share_track_info":"{\"link_description_type\":\"\"}","from":"web_code_link"},"pathname":"\u002Fshare\u002Fvideo\u002F7567686146130464042\u002F","host":"www.iesdouyin.com","url":"https:\u002F\u002Fwww.iesdouyin.com\u002Fshare\u002Fvideo\u002F7567686146130464042\u002F?region=CN&mid=7567686326007499574&u_code=ej0dk7l2g004jm&did=MS4wLjABAAAAUbqdg2vhJHRDnrU2k6QsMX9R8DJIDxbD8wjU_E9qx4GtnHvtF-aQdzAaHu7Awoye&iid=MS4wLjABAAAANwkJuWIRFOzg5uCpDRpMj4OX-QryoDgn-yYlXQnRwQQ&with_sec_did=1&video_share_track_ver=&titleType=title&share_sign=nMTU61AnSNUe7Te.Ww32ku_0KQeXIscQMDEXnYlVjz8-&share_version=170400&ts=1762160029&from_aid=6383&from_ssr=1&share_track_info=%7B%22link_description_type%22%3A%22%22%7D&from=web_code_link"},"reporter":{}},"mode":"string","renderLevel":2}</script>
<script nonce="">window._ROUTER_DATA = {"loaderData":{"video_layout":null,"video_(id)\u002Fpage":{"ua":"Mozilla\u002F5.0 (iPhone; CPU iPhone OS 16_0 like Mac OS X) AppleWebKit\u002F605.1.15 (KHTML, like Gecko) Version\u002F16.0 Mobile\u002F15E148 Safari\u002F604.1","isSpider":false,"webId":"7568470684830303796","query":{"region":"CN","mid":"7567686326007499574","u_code":"ej0dk7l2g004jm","did":"MS4wLjABAAAAUbqdg2vhJHRDnrU2k6QsMX9R8DJIDxbD8wjU_E9qx4GtnHvtF-aQdzAaHu7Awoye","iid":"MS4wLjABAAAANwkJuWIRFOzg5uCpDRpMj4OX-QryoDgn-yYlXQnRwQQ","with_sec_did":"1","video_share_track_ver":"","titleType":"title","share_sign":"nMTU61AnSNUe7Te.Ww32ku_0KQeXIscQMDEXnYlVjz8-","share_version":"170400","ts":"1762160029","from_aid":"6383","from_ssr":"1","share_track_info":"{\"link_description_type\":\"\"}","from":"web_code_link"},"renderInSSR":1,"lastPath":"7567686146130464042","appName":"safari","host":"www.iesdouyin.com","isNotSupportWebp":false,"commonContext":{"ua":"Mozilla\u002F5.0 (iPhone; CPU iPhone OS 16_0 like Mac OS X) AppleWebKit\u002F605.1.15 (KHTML, like Gecko) Version\u002F16.0 Mobile\u002F15E148 Safari\u002F604.1","isSpider":false,"webId":"7568470684830303796","query":{"region":"CN","mid":"7567686326007499574","u_code":"ej0dk7l2g004jm","did":"MS4wLjABAAAAUbqdg2vhJHRDnrU2k6QsMX9R8DJIDxbD8wjU_E9qx4GtnHvtF-aQdzAaHu7Awoye","iid":"MS4wLjABAAAANwkJuWIRFOzg5uCpDRpMj4OX-QryoDgn-yYlXQnRwQQ","with_sec_did":"1","video_share_track_ver":"","titleType":"title","share_sign":"nMTU61AnSNUe7Te.Ww32ku_0KQeXIscQMDEXnYlVjz8-","share_version":"170400","ts":"1762160029","from_aid":"6383","from_ssr":"1","share_track_info":"{\"link_description_type\":\"\"}","from":"web_code_link"},"renderInSSR":1,"lastPath":"7567686146130464042","appName":"safari","host":"www.iesdouyin.com","isNotSupportWebp":false},"isAiDouyinOpt":"","videoInfoRes":{"extra":{"logid":"202511032011474892F80BE0302618D9B2","now":1762171908111},"filter_list":[],"is_oversea":0,"item_list":[{"aweme_id":"7567686146130464042","desc":"不要试图偷窥邻居的生活，不然很可能遭到报复！ #steam游戏 #恐怖游戏","create_time":1761990632,"author":{"short_id":"45578329258","nickname":"香菜爱吃香菜","signature":"玩游戏我是认真的！\n恋人：@EMO菜 \n商务wz94329备注来意\n一个什么游戏都玩的主播（综合游戏达人）\n不卖号不加机构\n视频均来自直播素材  \n每晚10点","avatar_thumb":{"uri":"100x100\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5","url_list":["https:\u002F\u002Fp11.douyinpic.com\u002Faweme\u002F100x100\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5.jpeg?from=327834062","https:\u002F\u002Fp3.douyinpic.com\u002Faweme\u002F100x100\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5.jpeg?from=327834062","https:\u002F\u002Fp26.douyinpic.com\u002Faweme\u002F100x100\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5.jpeg?from=327834062"],"width":720,"height":720},"avatar_medium":{"uri":"100x100\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5","url_list":["https:\u002F\u002Fp11.douyinpic.com\u002Faweme\u002F100x100\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5.jpeg?from=327834062","https:\u002F\u002Fp3.douyinpic.com\u002Faweme\u002F100x100\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5.jpeg?from=327834062","https:\u002F\u002Fp26.douyinpic.com\u002Faweme\u002F100x100\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5.jpeg?from=327834062"],"width":720,"height":720},"follow_status":0,"aweme_count":437,"following_count":0,"favoriting_count":0,"unique_id":"1z12s","mplatform_followers_count":0,"followers_detail":null,"platform_sync_info":null,"geofencing":null,"policy_version":null,"sec_uid":"MS4wLjABAAAA6D2t1ngebLQfM73vgK87c_g-wG5BM1y587CQ2l9v14Y6PdeN_TeP11lEQt9XIj4l","type_label":null,"card_entries":null,"mix_info":null},"music":{"mid":"7567686326007499574","title":"@香菜爱吃香菜创作的原声一香菜爱吃香菜","author":"香菜爱吃香菜","cover_hd":{"uri":"1080x1080\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5","url_list":["https:\u002F\u002Fp11.douyinpic.com\u002Faweme\u002F1080x1080\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5.jpeg?from=327834062","https:\u002F\u002Fp26.douyinpic.com\u002Faweme\u002F1080x1080\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5.jpeg?from=327834062","https:\u002F\u002Fp3.douyinpic.com\u002Faweme\u002F1080x1080\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5.jpeg?from=327834062"],"width":720,"height":720},"cover_large":{"uri":"1080x1080\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5","url_list":["https:\u002F\u002Fp11.douyinpic.com\u002Faweme\u002F1080x1080\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5.jpeg?from=327834062","https:\u002F\u002Fp26.douyinpic.com\u002Faweme\u002F1080x1080\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5.jpeg?from=327834062","https:\u002F\u002Fp3.douyinpic.com\u002Faweme\u002F1080x1080\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5.jpeg?from=327834062"],"width":720,"height":720},"cover_medium":{"uri":"720x720\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5","url_list":["https:\u002F\u002Fp3.douyinpic.com\u002Faweme\u002F720x720\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5.jpeg?from=327834062","https:\u002F\u002Fp11.douyinpic.com\u002Faweme\u002F720x720\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5.jpeg?from=327834062","https:\u002F\u002Fp26.douyinpic.com\u002Faweme\u002F720x720\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5.jpeg?from=327834062"],"width":720,"height":720},"cover_thumb":{"uri":"168x168\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5","url_list":["https:\u002F\u002Fp3.douyinpic.com\u002Fimg\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5~c5_168x168.jpeg?from=327834062","https:\u002F\u002Fp11.douyinpic.com\u002Fimg\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5~c5_168x168.jpeg?from=327834062","https:\u002F\u002Fp26.douyinpic.com\u002Fimg\u002Faweme-avatar\u002Ftos-cn-avt-0015_ae1fab9956ed8c15aad0b479eaabdee5~c5_168x168.jpeg?from=327834062"],"width":720,"height":720},"duration":466,"position":null,"status":1},"cha_list":null,"video":{"play_addr":{"uri":"v0200fg10000d42t49nog65rbt3cnb6g","url_list":["https:\u002F\u002Faweme.snssdk.com\u002Faweme\u002Fv1\u002Fplaywm\u002F?line=0&logo_name=aweme_diversion_search&ratio=720p&video_id=v0200fg10000d42t49nog65rbt3cnb6g"]},"cover":{"uri":"tos-cn-i-dy\u002F482061480b9e467596b7d67edf5c3af0","url_list":["https:\u002F\u002Fp3-sign.douyinpic.com\u002Ftos-cn-i-dy\u002F482061480b9e467596b7d67edf5c3af0~tplv-dy-resize-walign-adapt-aq:540:q75.webp?lk3s=138a59ce&x-expires=1763380800&x-signature=PH5NLddJbK7kIjOgftXwQCNdBAc%3D&from=327834062&s=PackSourceEnum_DOUYIN_REFLOW&se=false&sc=cover&biz_tag=aweme_video&l=202511032011474892F80BE0302618D9B2","https:\u002F\u002Fp11-sign.douyinpic.com\u002Ftos-cn-i-dy\u002F482061480b9e467596b7d67edf5c3af0~tplv-dy-resize-walign-adapt-aq:540:q75.webp?lk3s=138a59ce&x-expires=1763380800&x-signature=dodPkV%2FmmrXSUEhbD%2F8PEqeXdMY%3D&from=327834062&s=PackSourceEnum_DOUYIN_REFLOW&se=false&sc=cover&biz_tag=aweme_video&l=202511032011474892F80BE0302618D9B2","https:\u002F\u002Fp26-sign.douyinpic.com\u002Ftos-cn-i-dy\u002F482061480b9e467596b7d67edf5c3af0~tplv-dy-resize-walign-adapt-aq:540:q75.webp?lk3s=138a59ce&x-expires=1763380800&x-signature=XvoP8grmLWGlqNSqlOGDL%2FHhrPk%3D&from=327834062&s=PackSourceEnum_DOUYIN_REFLOW&se=false&sc=cover&biz_tag=aweme_video&l=202511032011474892F80BE0302618D9B2","https:\u002F\u002Fp3-sign.douyinpic.com\u002Ftos-cn-i-dy\u002F482061480b9e467596b7d67edf5c3af0~tplv-dy-resize-walign-adapt-aq:540:q75.jpeg?lk3s=138a59ce&x-expires=1763380800&x-signature=UHvrx1OR9%2BCwHmDZfkmZ90IyAWw%3D&from=327834062&s=PackSourceEnum_DOUYIN_REFLOW&se=false&sc=cover&biz_tag=aweme_video&l=202511032011474892F80BE0302618D9B2"],"width":540,"height":721},"height":1080,"width":1920,"bit_rate":null,"duration":466267,"big_thumbs":null},"statistics":{"aweme_id":"7567686146130464042","comment_count":138,"digg_count":12231,"play_count":0,"share_count":1083,"collect_count":1554},"text_extra":[{"start":23,"end":31,"type":1,"hashtag_name":"steam游戏","hashtag_id":1608346897491988},{"start":32,"end":37,"type":1,"hashtag_name":"恐怖游戏","hashtag_id":1767586622634062}],"video_labels":null,"aweme_type":4,"image_infos":null,"risk_infos":{"warn":true,"type":53,"content":"作者声明：可能引人不适，请谨慎观看","reflow_unplayable":0},"comment_list":null,"geofencing":null,"video_text":null,"label_top_text":null,"promotions":null,"long_video":null,"images":null,"group_id_str":"7567686146130464042","chapter_list":null,"interaction_stickers":null,"img_bitrate":null,"chapter_bar_color":null,"common_labels":null}],"status_code":0},"itemId":"7567686146130464042","isVideoOptimize":false,"openDirectGroup":"4","isVideoStyleOptimize":true,"isButtonOptimize":true,"isAutoOpenApp":false,"darkModeAdaptation":false,"serverToken":"","abParams":{"reflow_video_page_optimize":"2","search_video_mark_abtest":"0","share_page_dark_mode_adaptation":"1","reflow_page_open_app_optimize":"4","reflow_page_auto_open_optimize":"0","reflow_to_featured_app":"1","select_pool_data":{"use_new_select_scope":0},"jx_label_display_position_list":["main","related_card"],"reflow_page_615883_optimaze":false}}},"errors":null}</script></body></html>`
...
// directHTTPRequest 直接使用HTTP请求获取页面内容
func (p *DouYinProcessor) directHTTPRequest(url string) (string, error) {
	client := &http.Client{
...
func (p *DouYinProcessor) initPlaywrightAndBrowser() (playwright.BrowserContext, playwright.Page, *playwright.Playwright, error) {
	...
	utils.InfoWithFormat("随机选择用户代理: %s", selectedUserAgent)
	...
	for _, scriptMatch := range scriptMatches {
		...
		for _, jsonMatch := range jsonMatches {
			...
			if hjd.VideoUrl != "" {
				...
				utils.InfoWithFormat("[extract] 回退方法成功提取视频信息: %v", hjd)
				return nil
			}
		}
	}
...
func (p *DouYinProcessor) findDataInJson(data map[string]interface{}) *htmlJsonData {
	...
	var findURL func(obj interface{}) bool
	findURL = func(obj interface{}) bool {
		switch v := obj.(type) {
		case map[string]interface{}:
			for key, value := range v {
				...
				if key == "video" {
					...
					if descValue, ok := v["desc"].(string); ok {
						hjd.Desc = descValue
					}
					if authorValue, ok := v["author"].(map[string]interface{}); ok {
						if nickname, ok := authorValue["nickname"].(string); ok && nickname != "" {
							hjd.Author = nickname
						}
					}
					if createTimeValue, ok := v["create_time"].(float64); ok {
						ctTime := datetime.FormatTimeToStr(time.Unix(int64(createTimeValue), 0), "yyyy-mm-dd hh:mm:ss")
						hjd.Time = ctTime
					}
				}
				...
				// 递归搜索其他字段
				found := findURL(value)
				if found && hjd.VideoUrl != "" {
					return true
				}
			}
		case []interface{}:
			for _, item := range v {
				if findURL(item) && hjd.VideoUrl != "" {
					return true
				}
			}
		}
...
func (p *DouYinProcessor) downloadVideo() error {
	...
	for _, videoInfo := range p.videos {
		...
		if videoInfo.CoverUrl != "" {
			...
			utils.InfoWithFormat("[download] 封面下载完成: %s", filepath.Join(fp, fn))
		}
	}
	return nil
}
...
func (p *DouYinProcessor) _downloadResource(url, savePath, filename string) (string, error) {
	...
	for {
		...
		time.Sleep(2 * time.Second) // 减少轮询间隔
	}
}
